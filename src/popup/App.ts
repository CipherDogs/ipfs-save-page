...
// import PrettyHex from '@galtproject/core/directives/PrettyHex/PrettyHex';
...
Vue.use(storePlugin, {
  ...
  [StorageVars.ExtensionTabPageUrl]: 'chrome-extension://' + (global as any).browser.runtime.id + '/tab-page/index.html',
});
